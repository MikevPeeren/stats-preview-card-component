      ...
      <div className={`${styles.StatsCard} rounded-2xl`}>
        <div className="flex flex-col-reverse sm:flex-row">
          <div className="flex flex-col items-center sm:w-2/4 my-6">
            ...
            <div className="flex flex-col sm:flex-row items-center text-center sm:w-3/4 mt-10">
          ...
          <div
            className={`${styles.BackgroundImage} h-64 max-h-96 bg-cover bg-no-repeat rounded-t-2xl`}
          />
        </div>
      </div>
    </div>
